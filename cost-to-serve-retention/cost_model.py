...
PRICES_PER_GB_MONTH = {
    ...
    # RE-VERIFIED 2026-06-14 (B-COST re-run): all three unchanged — gp3 $0.080, S3 Standard
    # $0.023, Glacier IR $0.004/GB-mo us-east-1, corroborated by the 2026-06-13 Gemini Tier-A
    # check (gp3 + S3 from official AWS pages) and a 2026 web cross-check (Glacier IR).
...
def main():
    ...
    out = {"reference_workload_gb_per_day_raw": RAW_GB_PER_DAY,
           "prices_as_of": "2026-06-10 AWS us-east-1 list, re-verified 2026-06-14 (all three unchanged; see PRICES comment)",
